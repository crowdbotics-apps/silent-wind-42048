"""
Django settings for silent_wind_42048 project.
...
ROOT_URLCONF = 'silent_wind_42048.urls'
...
WSGI_APPLICATION = 'silent_wind_42048.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_wind_42048 API",
    "DESCRIPTION": "API documentation for silent_wind_42048 App",
    "VERSION": "v1",
}
